...
function AdminForm() {
    const {darkMode, success, setSuccess, loader, setloader, alert, setAlert} = useContext(MyContext)
     ////// Form State ///////////
  ...
  const savedata = async () => {
    ...
    const token = localStorage.getItem('token')
      await axios.post(`${import.meta.env.VITE_BEACKEND_URL}/admin/create/data`, {
          headers:{
